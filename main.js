...
global.owner = ['${setting.ownerNumber}@s.whatsapp.net'] // Put your number here
global.mods = ['${setting.ownerNumber@s.whatsapp.net'] // Want some help?
global.prems = ['${setting.ownerNumber}@s.whatsapp.net'] // Premium user has unlimited limit
